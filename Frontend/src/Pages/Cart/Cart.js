...
import { REMOVE,INCREAMENT, DECREAMENT, CLEAR__CART } from '../../Redux/actions/Action';
import "./cart.css"
              ...
              cartData.map((prod)=>{
                ...
                return  <div class="row"> 
                  ...
                  <div class="col-lg-5 col-md-6 mb-4 mb-lg-0 ">
                    ...
                    <p>Color: blue</p>
                    <p>Size: M</p>
                    <button onClick={()=> dispatch(REMOVE(prod._id))} type="button" class="btn btn-primary btn-sm me-1 mb-2" data-mdb-toggle="tooltip"
                      title="Remove item">
            ...
            <div class="card mb-4  ">
              ...
              <div class="card-body summary" >
                <ul class="list-group list-group-flush">
                  ...
                  {
                    User ? <StripeCheckout name = "Shoping Center" image={ShopLogo}
                    billingAddress
                    shippingAddress
