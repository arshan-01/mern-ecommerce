      ...
      <>
        <section
          ...
          <MDBContainer className="py-5 h-100">
            ...
            {
             order?.status ==="Cancelled" &&  <MDBBadge pill light color='warning'>
             Cancelled
           </MDBBadge>
            }
            {
             order?.status ==="Delivered" &&  <MDBBadge pill light color='primary'>
             Delivered
           </MDBBadge>
            }</span>
                  ...
                  <MDBCardBody className="p-4">
  ...
  
                   {
                    ...
                    <MDBCardBody>
                      <MDBRow>
                        ...
                        <MDBCol
                          ...
                          className="text-center d-flex justify-content-center align-items-center"
                        >
                          <p className="text-muted mb-0 small">Qty: {product.qty}</p>
                        </MDBCol>
                        <MDBCol
                          md="2"
                          className="text-center d-flex justify-content-center align-items-center"
                        >
                          <p className="text-muted mb-0 small">${product.qty*product.price}</p>
                        </MDBCol>
                      </MDBRow>
                      <hr
                        className="mb-4"
                    ...
                    <div className="d-flex justify-content-between">
                      <p className="text-muted mb-0">
                        Invoice Date : {order?.createdAt && new Date(order?.createdAt).toISOString().slice(0,10)}
                      </p>
                      <p className="text-muted mb-0">
                  ...
                  <MDBCardFooter
                    ...
                    <MDBTypography
                      ...
                      >
                        {
                          order?.status==="Cancelled" ?  <p className="mt-3">Refunded Amount</p>:  <p className="mt-3">Total paid</p> 
                        }
